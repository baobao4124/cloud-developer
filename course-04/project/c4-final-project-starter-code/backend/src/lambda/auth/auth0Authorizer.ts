...
const jwksUrl = 'https://dev-sfaxonqn7136y10y.us.auth0.com/.well-known/jwks.json'
...
async function getCertificate(jwtKid: string): Promise<string> {
  try {
    ...
    logger.error(`Error fetching jwksUrl: ${JSON.stringify(e)}`)
  }
}
